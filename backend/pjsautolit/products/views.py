...
#     return re.sub(r'[^\w\s-]', '', title).strip().lower().replace(' ', '-') + '.html'
...
#         except Exception as e:
#             errors.append(f"Error writing file for product {product.item_id}: {str(e)}")
...
#     sanitized_title = slugify(product.title)
#     if not sanitized_title:
#         sanitized_title = str(product.item_id)
    
#     html_file_path = os.path.join('products', 'viewproduct', f'{sanitized_title}.html')
